...
switch ($_GET["op"]) {
    case "insert":
        $datos = $ticket->insert_ticket($_POST["usu_id"], $_POST["cat_id"], $_POST["tick_titulo"], $_POST["tick_descrip"], $_POST["staff_id"]);
    ...
    case "listar_x_usu":
        ...
        foreach ($datos as $row) {
            ...
            if($row["fech_asig"] == null){
                $sub_array[] = '<span class="label label-pill label-default">Ticket sin asignar</span>';
            }else{
